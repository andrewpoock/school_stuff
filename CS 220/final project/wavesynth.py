...
class WaveSynth:
    ...
    def set_waveform(self, waveform):
        ...
        """
        self._wavefunc = self._WAVE_FNS[waveform]
    ...
    def synthesize(self, freq, duration):
        ...
        """
        samples = tonelib.tone(self._wavefunc, freq, duration)
        if self._sustain > 0:
            tonelib.fadeout(samples, self._sustain)
        tonelib.adjvolume(samples, self._volume)
