...
class Vector:
    ...
    def __sub__(self, other):
        ...
        new = []
        for i in range(len(self._coords)):
            new.append(self._coords[i]-other._coords[i])
        return Vector(new)
    ...
    def dot(self, other):
        ...
        res = 0
        for i in range(len(self._coords)):
            res += self._coords[i]*other._coords[i]
        return res
    ...
    def mag2(self):
        ...
        res = 0
        for i in range(len(self._coords)):
            res += self._coords[i]*self._coords[i]
        return res
    ...
    def normalize(self):
        ...
        mag = self.mag()
        for i in range(len(self._coords)):
            self._coords[i] = self._coords[i]/mag
    ...
    def normalized(self):
        ...
        new_coords = []
        for i in range(len(self._coords)):
            new_coords.append(self._coords[i]/mag)
